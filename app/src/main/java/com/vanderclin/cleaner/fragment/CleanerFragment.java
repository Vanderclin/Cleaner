package com.vanderclin.cleaner.fragment;
...
import com.vanderclin.cleaner.activity.SettingsActivity;
import com.vanderclin.cleaner.model.AppsListItem;
import com.vanderclin.cleaner.model.CleanerService;
import com.vanderclin.cleaner.model.adapter.AppsListAdapter;
import com.vanderclin.cleaner.widget.DividerDecoration;
import com.vanderclin.cleaner.widget.RecyclerView;
...
public class CleanerFragment extends Fragment implements CleanerService.OnActionListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		coordinatorLayout = (CoordinatorLayout) rootView.findViewById(R.id.snack);
    ...
    public void onCleanCompleted(Context context, boolean succeeded) {
		...
		Snackbar snackbar = Snackbar.make(coordinatorLayout, succeeded ? R.string.cleaned : R.string.toast_could_not_clean, Snackbar.LENGTH_LONG);
